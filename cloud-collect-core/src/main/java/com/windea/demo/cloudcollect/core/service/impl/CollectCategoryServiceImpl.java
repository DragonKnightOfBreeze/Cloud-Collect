...
public class CollectCategoryServiceImpl implements CollectCategoryService {
	...
	//@Autowired MutableAclService aclService;
	//
	//public void addPermission(CollectCategory category, Sid recipient, Permission permission) {
	//	ObjectIdentity oi = new ObjectIdentityImpl(CollectCategory.class, 44L);
