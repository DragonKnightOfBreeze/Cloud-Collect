<template>
  <div>
    ...
    <EditCategoryDialog :visible.sync="editDialogVisible" @submit="handleSubmit"/>
...
<script lang="ts">import CategoryDetailCard from "@/components/card/CategoryDetailCard.vue"
